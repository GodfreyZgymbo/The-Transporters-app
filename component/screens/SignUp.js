        ...
        <div>
            <View>
                ...
                <View>
                    ...
                    <TextInput style={styles.imput} type="address"
                  
                    ></TextInput>
                </View>
                <View>
                    <Text><h3> Town</h3></Text>
                    <TextInput style={styles.imput} type="town"
                   
                    ></TextInput>
                </View>
                <View>
                    <Text><h3> Country</h3></Text>
                    <TextInput style={styles.imput} type="country"
                   
                    ></TextInput>
                </View>
                <View>
                    <Text><h3> Date of Birth</h3></Text>
                    <TextInput style={styles.imput} type="date"
